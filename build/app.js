...
/***/ function(module, exports, __webpack_require__) {
	...
	var MetadataActions = __webpack_require__(2);
	var SelectionActions = __webpack_require__(3);
	var MetadataStore = __webpack_require__(4);
	var ResultsStore = __webpack_require__(5);
	var SelectionStore = __webpack_require__(6);
	var WithFlux = __webpack_require__(7);
	var _ = __webpack_require__(13);
	
	var Header = __webpack_require__(8);
	var ResultList = __webpack_require__(9);
	var Detail = __webpack_require__(10);
						...
						React.DOM.div( {className:"main__sidebar row__column"}, 
							...
							React.DOM.ul( {className:"results-actions"}, 
								(selectionCount === this.state.results.length &&
									React.DOM.li(null, React.DOM.a( {href:"#", onClick:this._onRemoveAllClick, className:"t_action t_label c_action"}, "REMOVE THESE (",this.state.results.length,")"))
								) ||
									React.DOM.li(null, React.DOM.a( {href:"#", onClick:this._onAddAllClick, className:"t_action t_label c_action"}, "ADD THESE (",this.state.results.length,")"))
	...
	React.renderComponent(App(null ), document.getElementById('app-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var merge = __webpack_require__(18);
	var MetadataStore = __webpack_require__(4);
	var Fuse = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = React.createClass({displayName: 'Header',
		...
		render: function() {
			return (
				React.DOM.div( {className:"header cf row"}, 
						React.DOM.div( {className:"header__logo row__column"}, 
							React.DOM.a( {href:"#", className:"logo-nav c_linkbox"}, 
								React.DOM.span( {className:"logo"}, 
									React.DOM.img( {src:"logo.svg", alt:"Modernizr"} )
								)
							)
						),
						React.DOM.div( {className:"header__search row__column"}, 
							this.props.searchComponent
						),
						React.DOM.div( {className:"header__util"}, 
							React.DOM.ul( {className:"util"}, 
								React.DOM.li( {className:"util__item"}, 
									React.DOM.a( {href:"#", className:"build-state-btn hit c_linkbox"}, 
										React.DOM.strong( {className:"build-state-btn__char t_subtitle"}, this.props.count),
										React.DOM.span( {className:"build-state-btn__suffix t_label"}, "Detects")
									)
								),React.DOM.li( {className:"util__item"}, 
									React.DOM.a( {href:"#", className:"build-state-btn hit c_linkbox"}, 
										React.DOM.strong( {className:"build-state-btn__char t_subtitle"}, "0"),
										React.DOM.span( {className:"build-state-btn__suffix t_label"}, "Extras")
									)
								),React.DOM.li( {className:"util__item"}, 
									React.DOM.a( {href:"#", className:"build-state-btn hit c_linkbox"}, 
										React.DOM.strong( {className:"build-state-btn__char t_subtitle"}, " "),
										React.DOM.span( {className:"build-state-btn__suffix t_label"}, "Standard")
									)
								),React.DOM.li( {className:"util__item"}, 
									React.DOM.div( {className:"build-state-btn build-state-label t_label"}, 
										"10KB"
									)
								),React.DOM.li( {className:"util__item"}, 
									React.DOM.a( {href:"#", className:"t_action t_action--primary hit build-state-btn c_primary build-state-label"}, 
										"Build"
									)
								)
							)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TagResult = __webpack_require__(15);
	var ResultActions = __webpack_require__(16);
	var SelectionActions = __webpack_require__(3);
				...
				React.DOM.div( {className:"detail c_box"}, 
					...
					React.DOM.ul( {className:"tags"}, 
						React.DOM.li(null, 
							...
							React.DOM.a( {href:"#", className:"t_label c_linkbox"}, "animation")
						)),
						React.DOM.h1(null, this.props.detect.name),
						authors &&
							React.DOM.p(null, "by ", authors),
						
						this.props.detect.doc &&
						React.DOM.div( {className:"desc", dangerouslySetInnerHTML:{__html: this.props.detect.doc}} ),
						
						React.DOM.h2(null, "Usage"),
						React.DOM.dl( {className:"cf"}, 
						React.DOM.dt(null, "CSS"),
						React.DOM.dd(null, React.DOM.code(null, '.css-transitions .foo { }')),
						React.DOM.dt(null, "JS"),
						React.DOM.dd(null, React.DOM.code(null, 'if(Modernizr.csstransitions)'))
					)
				)
			);
		}
		...
		render: function() {
			return (
				React.DOM.div( {className:"search"}, 
					React.DOM.input( {type:"text", autoFocus:true, onChange:this._onInputChange, className:"search__input t_search-label", placeholder:"Type a browser feature"} )
				)
			);
		},
		...
		render: function() {
			...
			return (
				React.DOM.div( {className:classes, onClick:this._onClick}, 
					React.DOM.span( {className:"result__name"}, this.props.detect && this.props.detect.name, " ", this.props.added && '✔'),
					React.DOM.div( {className:"result__add-action c_action add-action t_action", onClick:this._onToggleBtnClick}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dispatcher = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mergeInto = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RSVP = __webpack_require__(103);
	var merge = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mergeHelpers = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mergeInto = __webpack_require__(23);
	var objMapKeyVal = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DefaultDOMPropertyConfig = __webpack_require__(71);
	...
	var ReactEventTopLevelCallback = __webpack_require__(78);
	var ReactDOM = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createObjectFrom = __webpack_require__(98);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.binding = function (name) {
	    if (name === 'evals') return (__webpack_require__)(102)
	...
	(function () {
	    ...
	    exports.chdir = function (dir) {
	        if (!path) path = __webpack_require__(101);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactEventEmitter = __webpack_require__(68);
	var ReactInputSelection = __webpack_require__(119);
	var ReactMountReady = __webpack_require__(140);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var filter = __webpack_require__(142);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Promise = __webpack_require__(151)["default"];
	var EventTarget = __webpack_require__(152)["default"];
	var denodeify = __webpack_require__(153)["default"];
	var all = __webpack_require__(154)["default"];
	var allSettled = __webpack_require__(155)["default"];
	var race = __webpack_require__(156)["default"];
	var hash = __webpack_require__(157)["default"];
	var hashSettled = __webpack_require__(158)["default"];
	var rethrow = __webpack_require__(159)["default"];
	var defer = __webpack_require__(160)["default"];
	var config = __webpack_require__(161).config;
	var configure = __webpack_require__(161).configure;
	var map = __webpack_require__(162)["default"];
	var resolve = __webpack_require__(163)["default"];
	var reject = __webpack_require__(164)["default"];
	var filter = __webpack_require__(165)["default"];
	var asap = __webpack_require__(166)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(161).config;
	var EventTarget = __webpack_require__(152)['default'];
	var instrument = __webpack_require__(169)['default'];
	var objectOrFunction = __webpack_require__(170).objectOrFunction;
	var isFunction = __webpack_require__(170).isFunction;
	var now = __webpack_require__(170).now;
	var cast = __webpack_require__(171)['default'];
	var all = __webpack_require__(172)['default'];
	var race = __webpack_require__(173)['default'];
	var Resolve = __webpack_require__(174)['default'];
	var Reject = __webpack_require__(175)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* global  arraySlice */
	var Promise = __webpack_require__(151)['default'];
	var isArray = __webpack_require__(170).isArray;
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Promise = __webpack_require__(151)['default'];
	var isArray = __webpack_require__(170).isArray;
	var isNonThenable = __webpack_require__(170).isNonThenable;
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Promise = __webpack_require__(151)['default'];
	var isNonThenable = __webpack_require__(170).isNonThenable;
	var keysOf = __webpack_require__(170).keysOf;
	/**
